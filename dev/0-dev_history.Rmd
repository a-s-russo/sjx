...
fusen::fill_description(
  ...
  fields = list(
    ...
    Version = "0.1",
    Description = "This package contains functions to download and clean time series data from the Australian Bureau of Statistics (ABS) and compare the outputs from the seasonal adjustment and trend methods of X-13ARIMA-SEATS and JDemetra+ against those published by the ABS (which uses SEASABS).",
    `Authors@R` = c(
...
local({
  ...
  usethis::use_data(BIA_Mar23_Table3, overwrite = TRUE)
  usethis::use_data(BIA_Mar23_Table6, overwrite = TRUE)
  usethis::use_data(LFA_Jul23_Table1, overwrite = TRUE)
})
